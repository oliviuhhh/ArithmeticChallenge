...
public class GameActivity extends AppCompatActivity {
    ...
    private void setViewObjects(){
       ...
       // if(operation.equals("addition"))
        ...
        mProgressBar = findViewById(R.id.progressBar_lab3);
        mScoreText = findViewById(R.id.textView_yourScore);
        mHighScoreText = findViewById(R.id.textView_highscore);
        mChoice[0] = findViewById(R.id.button_num1);
        mChoice[1] = findViewById(R.id.button_num2);
        mChoice[2] = findViewById(R.id.button_num3);
    ...
    private void listenForClicks(boolean newQuestion){
        ...
        game.setChoice(game.createChoices());
